class CountryListDollar extends HTMLElement {
	constructor() {
		super();
	}
	...
	render() {
		this.innerHTML = `
			...
			<div class="wrapper">
		  		<div id="dollarcountryList">

				</div>
			</div>
		`;
		const spanishCountryElement = document.querySelector('#dollarcountryList');
...
customElements.define('country-list-dollar', CountryListDollar);