class CountryListSpanish extends HTMLElement {
	constructor() {
		super();
	}
	...
	render() {
		this.innerHTML = `
			...
			<div class="wrapper">
		  		<div id="spanishcountryList">

				</div>
			</div>
		`;
		const spanishCountryElement = document.querySelector('#spanishcountryList');
		spanishCountryElement.innerHTML = '';
...
customElements.define('country-list-spanish', CountryListSpanish);