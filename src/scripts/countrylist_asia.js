class CountryListAsia extends HTMLElement {
	constructor() {
		super();
	}
	...
	render() {
		this.innerHTML = `
			...
			<div class="wrapper">
		  		<div id="asiacountryList">

				</div>
			</div>
		`;
		const asiaCountryElement = document.querySelector('#asiacountryList');
		asiaCountryElement.innerHTML = '';
...
customElements.define('country-list-asia', CountryListAsia);